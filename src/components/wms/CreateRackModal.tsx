    ...
    <div className="fixed inset-0 bg-foreground/20 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-card rounded-xl shadow-2xl w-full max-w-lg border border-border">
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div>
            <h2 className="text-lg font-bold text-foreground">Create New Rack</h2>
            <p className="text-xs text-muted-foreground mt-0.5">Define structural parameters for warehouse storage units.</p>
          </div>
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t border-border">
          ...
          <Button onClick={onClose}>Save Rack Configuration</Button>
        </div>
      </div>
    </div>
  );
